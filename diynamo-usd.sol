...
contract Dynamo is ERC20 {
    ...
    function setStable1(price) public onlyOwner {    
        _stable1 = price;
    }
    
    function setStable2(price) public onlyOwner {    
        _stable2 = price;
    }
    
    function setStable3(price) public onlyOwner {    
        _stable3 = price;
    }
    
    function setStable4(price) public onlyOwner {    
        _stable4 = price;
    }
    
    function setStable5(price) public onlyOwner {    
        _stable5 = price;
    }
